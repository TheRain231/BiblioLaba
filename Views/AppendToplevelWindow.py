...
class AppendToplevelWindow(CTkToplevel):
    def __init__(self, *args, **kwargs):
        ...
        self.titleEntry.grid(padx=10, pady=5, sticky="ew")
        self.authorEntry.grid(padx=10, pady=5, sticky="ew")
        self.genreEntry.grid(padx=10, pady=5, sticky="ew")
        self.publisherEntry.grid(padx=10, pady=5, sticky="ew")
        self.coverEntry.grid(padx=10, pady=5, sticky="ew")
        self.descriptionEntry.grid(row=6, padx=10, pady=5, sticky="nsew")

        self.counter = Counter(self)
        self.counter.grid(row=7, padx=10, pady=5, sticky="se")
...
class Counter(CTkFrame):
    def __init__(self, master, *args, **kwargs):
        ...
        self.counterLabel = CTkLabel(self, text="1", width=30)
